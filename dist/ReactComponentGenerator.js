...
var ReactComponentGenerator = /** @class */ (function (_super) {
    ...
    ReactComponentGenerator.prototype.renderComponentJSX = function (content) {
        ...
        return jsx_1.default(mappedType, childrenJSX, styleNames);
    };
    ...
    ReactComponentGenerator.prototype.generate = function (component, options) {
        ...
        // tslint:disable-next-line:max-line-length
        return prettier.format(component_1.default(name, jsx, dependencies, styles, props), deepmerge(prettier_1.default, options.prettier || {}));
...
//# sourceMappingURL=ReactComponentGenerator.js.map