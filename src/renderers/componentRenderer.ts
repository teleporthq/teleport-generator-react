...
function renderComponent(content: any, target: Target, styleMaps: any, jsxMetadata?: JSXMetadata, isJSX: boolean = false): string {
...
function generateChildrenElements(children: any, target: any, inlineStyle: string, jsxXMetadata?: JSXMetadata, isJSX: boolean = false): any {
